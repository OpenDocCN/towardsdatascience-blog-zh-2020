...
> 原文：<https://towardsdatascience.com/forecasting-time-series-data-stock-price-analysis-324bcc520af5?source=collection_archive---------14----------------------->

## 时间数列预测法

## 重点介绍了使用不同的平滑方法和 Python 中的 ARIMA 对时间序列数据进行预测。

![](img/07aa72cd9c3b6fca5dbe4d78c854c762.png)

[lo lo](https://unsplash.com/@bylolo?utm_source=medium&utm_medium=referral) 在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 上拍照
...
![](img/3f95381672081b793e441d492c38224c.png)
...
![](img/ab8ea040e781ad5417c0e96cb5f40c44.png)![](img/9b8f03802ccf07d70f39c6db3e2a49de.png)

加法和乘法季节性——资料来源: [kourentzes](https://kourentzes.com/forecasting/2014/11/09/additive-and-multiplicative-seasonality/)

在加法版本中，季节性模式的幅度仍然与上升趋势无关，而在乘法版本中，它随着时间序列趋势的增加而增加。

# 如何获取股价数据？

我们可以通过使用[请求](https://pypi.org/project/requests/)包创建一个 API 请求来获取股票价格。我们也可以使用 [quandl](https://www.quandl.com/) 包，它被设计用来提供金融和经济数据。

我们将通过创建一个 **API 调用**从 [alphavantage](http://www.alphavantage.co) 网站提取美国股票的价格。使用下面的代码片段，我们提取了 IBM 的每日股票价格。您可以参考此[链接](https://www.alphavantage.co/documentation/)来更改您的请求需求。
...
对于这两种方法，您都需要创建一个 API 键，用于获取数据。你可以通过点击这些链接轻松获得你的 API:[alpha vantage](https://www.alphavantage.co/support/#api-key)和 [quandl](https://www.quandl.com/sign-up) 。

现在我们已经得到了数据，我们需要绘制它来获得趋势的概貌。

![](img/65308240edb181785d4ee2bb8015288f.png)

趋势会像股票一样经历一些起伏。这不是季节性的，因为季节性因素并不能提供更清晰的情况。除了一些观察结果，残差的方差似乎保持不变。

# 检查平稳性

对于 ARIMA，必须使时间序列**静止**以便进一步分析**。**对于一个平稳的时间序列，它的统计特性(均值、方差等)在整个序列中都是相同的，与你观察它们的时间无关。平稳的时间序列没有长期可预测的模式，如趋势或季节性。时间图将显示序列大致具有恒定方差的水平趋势。
...
![](img/207bd0232e40d600738a149bddca6032.png)![](img/b513e07a5f7fc5d08f9a7864a2de8e26.png)
...
![](img/d166b706eb9b7d888c7599e042fa98d5.png)![](img/43b139ead76315e25dc1b8729c307ca6.png)![](img/75b88ec39b2acfee12cd52f83836f4a5.png)

时间序列去趋势化后，ADF 和 KPSS 检验表明时间序列是平稳的。部分自相关函数(PACF)图表明，相关性存在于某些滞后。

## 分割数据集

![](img/5564141fd6c5783f014e3da7373bb060.png)
...
![](img/cbfb1a760570ad46fd8d274ff15d3eaa.png)

简单指数平滑

简单指数平滑片段

![](img/cdcd650d1ab855858d1f0b64ea1f19bb.png)
...
![](img/a0a54325f16b1a3c8e4025b5835fb459.png)

霍尔特指数平滑法

霍尔特的指数平滑片段

![](img/f2391951bc16ec34967316b00a7e9f47.png)
...
![](img/2447d03e0e9043319d3a149819eefe9c.png)

加法(来源: [otexts](https://otexts.com/fpp2/holt-winters.html)

![](img/b6ba794b71ca0439702c4cdca5f2aea9.png)

乘法(来源: [otexts](https://otexts.com/fpp2/holt-winters.html)
...
![](img/a26b00e55c3e437f4b14dff9890bca17.png)
...
![](img/6df834b91d17c40e387a2fc6010aa2f8.png)
