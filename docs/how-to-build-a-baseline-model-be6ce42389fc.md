...
![](img/30d906c906db8ab35ef32c88076b5fc7.png)
...
实现的分类器的特征重要性与探索性数据分析部分中提供的发现一致。 *Junction_Control、*Geo 变量和 *Ploice_Force* 是具有最高鉴别能力的特征。从设计特征来看，最重要的是*周期*和*高峰时间*。通过引入新的地理相关变量或提高 *Junction_Control* 变量的质量，我们可以将这些见解用于未来的特征工程。
