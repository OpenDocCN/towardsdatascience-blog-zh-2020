...
![](img/c2cb7a67bb4a8d0225d2402b3f0b7bfe.png)
...
![](img/4c978a8a8f48571d1218492964d4fed0.png)

照片由 [Gradikaa Aggi](https://unsplash.com/@gradikaa_?utm_source=medium&utm_medium=referral) 在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 上拍摄
...
![](img/6287be2fab5f33316f84ea1328854803.png)
...
![](img/6814964b9be677a654e7c496564dbdba.png)

马修·T·雷德在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 上的照片

人们会注意到你的帖子。这可能不会马上发生，但他们会的。通过我的一些旧博客帖子，我得到了一家出版公司的关注，该公司出版关于数据科学和其他技术领域的书籍和课程。找到我的那家公司的人认为我写得足够好，他想雇用我为 [Tensorflow](https://www.tensorflow.org/) 制作一个在线课程。但是，如果你只是把所有的工作都放在本地机器上，这种机会的几率将永远为零。

# 4.帮助他人，即使是多年以后

![](img/13510d0a767330b1e9c42c81029811ff.png)
...
我大约一年前写的一些博客帖子今天仍然对人们有帮助。我仍然会收到关于我的帖子如何为某人澄清了一个概念或者为他们提供了有趣的想法的消息。当我写这篇文章的时候，我刚刚在 LinkedIn 上收到一条消息，说有人觉得我写的这篇[前一篇](/data-science-applications-for-schools-d8913d21d363)很有趣！

# 5.间接为自己建立参考

![](img/df8f27c2337fdf6891d8816bf8345b9d.png)
...
[经验累积分布函数](/what-why-and-how-to-read-empirical-cdf-123e2b922480)是我在探索性数据分析中经常使用的图表。但是如果很长一段时间我不使用它，我会忘记创建它的确切代码。在我关于[重构数据科学代码](/data-science-code-refactoring-example-14c3ec858e0c)的帖子中，我使用了我为 ECDF 创建的函数，我可以在将来随时引用它。每当我需要使用 ECDF 很长一段时间后，我总是回到那个职位，以获得代码。

你也可以对你的文章做同样的事情。它可以是任何东西，从一个简单的函数到你发布的整个机器学习管道的代码。你的观众的参考也是你的参考。

# 6.反思过去的经历

![](img/6da91aafb7f4de400cf96080862bdf65.png)

照片由[兰迪·雅各布](https://unsplash.com/@randvmb?utm_source=medium&utm_medium=referral)在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 拍摄

冒名顶替综合症是一种信念，认为自己不够好，即使你的技能与此相反。回头看看你的帖子会提醒你你有什么能力。它们将提醒您在数据科学之旅中所做的所有艰苦工作。它会提醒你，即使有些人不这么看，你也足够优秀。

# 7.为你未来的职业生涯提高你的写作技巧

![](img/b3d82de7f7c4aaf9de74272fce50826f.png)
...
![](img/6aa515fffc07084c923ec27cfb01f1cb.png)

照片由[莫妮卡·梅尔顿](https://unsplash.com/@monicomelty?utm_source=medium&utm_medium=referral)在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 上拍摄
...
2.  **选择任何你觉得可以解释的小概念/话题:**你不必在第一篇博文中解释整个机器学习工作流程及其背后的数学原理。可以像概率分布、图表类型、您最喜欢的库或如何编写 Python 类一样简单。同样，我的第一篇文章是一个简单的[网页抓取](/python-web-scraping-refactored-5834dda39a65)的例子。那里没有什么新奇的东西，但它打开了通向更多的大门。
...
[](http://varianceexplained.org/r/start-blog/) [## 给有抱负的数据科学家的建议:开一个博客

### 上周我在 Twitter 上分享了一个想法:当你已经写了三次相同的代码时，写一个函数，当你已经给了…

varianceexplained.org](http://varianceexplained.org/r/start-blog/) 

这篇文章描述了[作者](https://towardsdatascience.com/@williamkoehrsen)每周写一次博客的好处。

[](/what-i-learned-from-writing-a-data-science-article-every-week-for-a-year-201c0357e0ce) [## 我从一年来每周写一篇数据科学文章中学到了什么

### 关于写作和数据科学改变生活的力量的课程

towardsdatascience.com](/what-i-learned-from-writing-a-data-science-article-every-week-for-a-year-201c0357e0ce) 

感谢阅读！你可以在 [Linkedin](https://www.linkedin.com/in/jdejesus22/) 和 [Twitter](https://twitter.com/johnnydata22?lang=en) 上关注或联系我。对 Twitter 上的 DM 开放。

那么你还在等什么？开始写博客吧！记住…

![](img/42886a0a727cd31db0b4192e731686fe.png)
