...
![](img/ddfecb5c0d770acc38c17ff9252311bb.png)

查尔斯在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 上的照片

由于时间和预算越来越紧张，公司不得不设计或利用创新的方法来赢得这场人才大战。麦肯锡预测，世界将出现人才短缺——确切地说，4000 万受过大学教育的工人太少。[万宝盛华集团最近的人才短缺调查](https://www.gartner.com/en/newsroom/press-releases/2019-01-17-gartner-survey-shows-global-talent-shortage-is-now-the-top-emerging-risk-facing-organizations)发现，38%的雇主难以填补职位空缺。随着就业市场竞争越来越激烈，公司开始转向技术的最新发展:人工智能系统来寻找、筛选和雇用最佳候选人。
...
这导致了一个突破性的发展:公司[越来越多地使用人工智能和数据科学](https://hbr.org/2018/07/want-less-biased-decisions-use-algorithms)来决定他们的招聘决定。

最初是有道理的。这些由数据科学家和招聘经理构建的算法旨在消除人类偏见。传统上，人类有[偏见和偏好](https://www.nytimes.com/2015/06/26/upshot/can-an-algorithm-hire-better-than-a-human.html)，这使得我们的招聘决定不公平——这就是为什么如果你和面试官有相同的爱好，你会在面试中表现得更好的原因。这会建立融洽的关系，这会影响面试后对他们的评价。

算法消除了这种模糊的判断。毕竟，计算算法常常胜过人类的判断，这意味着我们常常[信任它胜过信任自己](https://medium.com/swlh/you-trust-the-algorithm-more-than-the-human-4760f7213a0a)。
...
亚马逊依靠 2014 年创建的内部“秘密”招聘算法，根据候选人相对于公司最佳表现者的特质来评估候选人。三年后，当他们发现[压倒性地偏向男性](https://www.reuters.com/article/us-amazon-com-jobs-automation-insight/amazon-scraps-secret-ai-recruiting-tool-that-showed-bias-against-women-idUSKCN1MK08G)时，该计划被取消了:公司的顶级员工中男性比例过高(这可能是固有的性别偏见的结果)。
...
特斯拉明确表示:“当前的[自动驾驶功能需要主动的驾驶员监督](https://www.tesla.com/autopilot)，并且不能使车辆自动驾驶”。

就像特斯拉的自动驾驶功能一样，招聘算法也是一样的。我们[距离完全自动驾驶汽车还有几十年](https://www.businessinsider.com/self-driving-cars-fully-autonomous-vehicles-future-prediction-timeline-2019-8?IR=T)的时间，这同样适用于雇佣算法。好的算法是存在的，但成功不是偶然发生的。公司不应该在早期过度依赖算法，而应该审计和修改算法，以防止不公平现象继续存在。

因此，应该严格审查招聘建议。招聘经理必须将此类算法视为辅助手段，而非万灵药。

## 用人工审查审计其公正性

对于公司来说，加快招聘时间和简化流程的好处[通常会超过无意歧视的风险](https://hbr.org/2019/10/using-ai-to-eliminate-bias-from-hiring?referral=03759&cm_vc=rr_item_page.bottom)。
...
在宾夕法尼亚州立大学和哥伦比亚大学，研究人员开发了一种人工智能工具来检测基于属性的歧视。人力资源科技初创公司 Pymetrics 开源审计人工智能(Audit AI)，这种算法还可以确定算法中是否存在[系统偏差](https://venturebeat.com/2018/05/31/pymetrics-open-sources-audit-ai-an-algorithm-bias-detection-tool/)(尽管它涵盖了更广泛的算法类型)。
...
算法的力量和做出数据驱动的决策是当今公司必须利用的东西。与麦肯锡的预测一样，人才大战已经爆发——更年轻的劳动力和思维模式的转变加剧了这场战争。为了更快地筛选，更快地招聘，*和*仍然能提高候选人的质量，招聘经理最终会转向人力资源技术供应商或在内部开发算法(如果他们有时间和资源的话)。
...
想要更多这样的文章吗？我是 [*人+商业*](https://medium.com/the-human-business/welcome-to-human-business-d6bd9968d7ed) *的创始人，一家专注于领导力和人性化的媒体刊物。点击此处阅读更多内容，了解我们如何改变管理员工的方式。*