...
![](img/29678b522566d5e3b1294cf94ea926ad.png)

[路易斯·罗查](https://unsplash.com/@theluisrocha?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)在 [Unsplash](https://unsplash.com/?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) 上的照片
...
> **注意:**这将是我的“关于机器学习”课程的第一部分。但是，每个后续零件都将是独立零件。你可以根据你的方便以任何顺序阅读这个系列。我将在接下来的文章中尝试涵盖基础知识和大多数机器学习算法。要查看该系列的其他部分，您可以点击[此处](http://towardsdatascience.com/tagged/All%20About%20ML)。

## **为什么 AI 这么受欢迎？**

![](img/6d613c22f417670e8355a989e40f3a3f.png)

本杰明·戴维斯在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 拍摄的照片
...
要了解更多关于人工智能及其与宇宙的类比，你可以参考[这里](https://medium.com/illumination/artificial-intelligence-the-rise-of-technological-era-23f692bcbd56)。在本文中，我们将更多地关注机器学习。我会尝试给出一个更直观的理解机器学习的方法。
...
根据[维基](https://en.wikipedia.org/wiki/Reinforcement_learning#:~:text=Reinforcement%20learning%20(RL)%20is%20an,supervised%20learning%20and%20unsupervised%20learning.) —
...
![](img/0d114cd0d20293c01ffaa7ead0c84610.png)

照片由[奥斯汀·柯克](https://unsplash.com/@austinkirk?utm_source=medium&utm_medium=referral)在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 拍摄
...
要开始使用 python，可以从[这里](https://www.python.org/downloads/)下载。

## 结论:

我希望你们都喜欢这本书。这将是我的“关于机器学习”系列教程的第 1 部分。我计划涵盖所有关于机器学习的主题。在本系列的下一部分，我们将回顾 python 及其库的所有基础知识。所有这些都是独立的部分，您可以随时查看它们。点击查看该系列[的未来部分。谢谢大家坚持到最后，祝大家有美好的一天。](http://towardsdatascience.com/tagged/All%20About%20ML)