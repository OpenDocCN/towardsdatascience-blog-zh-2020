...
图 2:广泛使用的 TU 数据集的统计数据。资料来源 [Errica 等人，2020 年](https://openreview.net/forum?id=HygDF6NFPB)
...
图 6:我们在*稠密*秩 2 张量上运行的 WL-gnn 的标准实验流水线。
