...
![](img/77a212dfe9f3e677fff11d4f47d2c0ff.png)
...
**你至少需要一个定义明确的项目**，不是学校的项目，至少是**能引起讨论的有趣项目**。因此，你只需要准备好面试时他们可能会问你的所有问题。如果你足够聪明，你可以有意省去一些项目的关键点，让他们来问你。
...
如果你没有读过我在 Airbnb 上的文章，这篇文章也刊登在《亚洲科技》上，请点击这个[链接](/how-to-invest-in-the-best-airbnb-rental-property-kuala-lumpur-6bef8cb1477a)。

这是我如何从网上想到这个主意的。有一个叫做[的网站。我发现在互联网上可以找到的关于 Airbnb 的大多数项目都在使用这个网站的数据集。有趣的是，马来西亚的数据集没有出现在那里。](http://insideairbnb.com/get-the-data.html)
...
这个问题可能你甚至你的朋友都面临。我在[我的 Airbnb 文章](/how-to-invest-in-the-best-airbnb-rental-property-kuala-lumpur-6bef8cb1477a)中提供的额外价值，其实就是我朋友面临的问题。他问我是否有办法解决这个问题，我接受了挑战。

此外，你可以解决你的一些疑惑。例如，您有兴趣知道哪家公司在马来西亚的汽车市场拥有最大的市场，以及每家公司明年的销售额是多少。遵循我在[上一篇文章](/how-to-start-your-first-data-science-project-9c2afcaaa1a)中提到的三个步骤，识别并阐明问题，然后进行分析和建模。
