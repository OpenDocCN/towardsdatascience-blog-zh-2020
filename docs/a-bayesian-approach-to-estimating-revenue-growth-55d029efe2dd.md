...
![](img/eb9a4927b8234fe350e4a039e0dfec6d.png)
...
![](img/29d48463f217a5f68e6f2923e06e9a62.png)
...
![](img/20f8791dc88548aa3ca4f51e8d0452d0.png)
...
![](img/fdc0342656113c5387a1a3cfa897a88f.png)
...
![](img/13e94d822132230767df1bd6fdfab5cb.png)

这相当于

![](img/526086f039936dec9377fc9728ec9cf7.png)
...
![](img/a0e5c926f752a393427e590e9f664990.png)

换句话说，我试图建模的分布是给定样本增长率的平均收入增长率的分布。我将用样本数据和一点点判断来定义这个分布 *P* ( *Y* | *θ* )。我还需要平均增长率的先验分布 *P* ( *θ* )和数据的边际分布 *P* ( *Y* )。分析员有责任定义抽样分布以及定义 *θ* 的先验分布。一旦有了采样分布*P*(*Y*|*θ*，获得 *P* ( *Y* )的正确方法就是求解下面的积分:

![](img/adfd9aea2a1c4cb4da6025758112f793.png)
...
![](img/bff9fc67d4f3959e74192cc926d585a8.png)
...
![](img/de1861d41cfcb5ae35b1840422335f4f.png)
...
![](img/cf65cd014c33436af25b0e7a0741e5c7.png)

其中第一项指的是后验均值，第二项指的是后验方差。计算这些更新参数的公式如下

![](img/7c11e1808ee71939d27faa9eecf9150c.png)

和

![](img/b27f949c5ab6b7584d34e18740bc781e.png)

这些公式可能看起来有点吓人，但希望你能看到它们之间的一些相似之处。对于获得对这些公式的直觉来说，一个常见的并且特别有用的实践是从精度而不是方差的角度来看公式。精度是方差的倒数。

在这种情况下，我们需要观察三个相关的精度:

![](img/e37c0941207e67cf767fee4b3122c894.png)

如果将后验方差公式倒过来计算后验精度，可以看到后验精度用标准差表示为

![](img/95b15751bfa5880811118e4c970fd2ee.png)

这可以精确地写成

![](img/25729d23d3820b1ed6ade1c1e0c711a8.png)

在这种形式中，显然后验精度是先验精度和样本精度之和乘以样本大小。后验均值也可以根据精度重写:

![](img/325e710a0651339b89901e6444515ac9.png)

这里，很明显，后验均值是先验均值和样本均值的加权平均值。

对于数据，后验参数为:

![](img/5a857dd43bbf59a6e9b6e19152842f90.png)
...
![](img/802dd92812cb40831b744f2e699c7361.png)

我也会画出分布图。

![](img/3a7cebf6b9b0656871c5b9e6b5fbd61b.png)
...
[https://github.com/vinai-oddiraju/TDS_Blog_Post1.git](https://github.com/vinai-oddiraju/TDS_Blog_Post1.git)
