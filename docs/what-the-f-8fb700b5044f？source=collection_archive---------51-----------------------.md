...
![](img/969308bd30281b78f6a5f3b3c844f783.png)

[来源](https://media.giphy.com/media/3owzW5c1tPq63MPmWk/giphy.gif)
...
![](img/9b153644902d5a013f0239523ac5a224.png)

[来源](https://thumbs.gfycat.com/SimilarChiefGhostshrimp-size_restricted.gif)

你看一下过去的[数据](https://www.kaggle.com/ashydv/advertising-dataset)(图 1)，你可以用肉眼看出，很明显，你在每个媒体渠道——电视、广播和报纸——上投入的广告金额对产品的销售有影响。

![](img/83ecaf11a7df83100475b9e6a250fc2f.png)

图 1:每个广告媒体的销售额(以千单位计)与预算(以千美元计)

作为一名数据科学家，您希望了解并解释这三者是如何共同影响销售的。换句话说，我们希望将销售建模为电视、广播和报纸预算的 ***函数*** 。是的，这就是我们难以捉摸的“f”字——函数。

![](img/f23410135d0e5724e0425cbe292659d6.png)
...
![](img/efceece6ccc13c85828b99770a4ade04.png)

[来源](https://thumbs.gfycat.com/ChiefBogusBeagle-size_restricted.gif)

在产品销售和广告媒体预算的上下文中，函数 f 将电视、广播和报纸预算(分别由 X1、X2 和 X3 表示)作为输入，并将销售额 Y 作为输出。(我们以组合形式表示 X1、X2 和 X3——作为向量 X)

![](img/f18a571e8aec8fa69268a6da9adc72a6.png)

> 剧透警报！许多机器学习实际上只是提出一个好的 f，它可以接受一些输入数据并返回一个可靠的输出。

# 我们为什么要这个 f？

![](img/654dae1847bb6dc0882e4ee5c6ec6517.png)

[来源](https://media1.giphy.com/media/s239QJIh56sRW/giphy.gif)
...
*![](img/29eaa56c707abbdce37a0e3546d96162.png)*

*[来源](https://i.gifer.com/1bDq.gif)*
...
*![](img/a9c53c7cd16171571c293faedac70570.png)*

*[来源](https://media0.giphy.com/media/JzzLFXnZt4aiI/200.gif)*

*在“现实世界”中，我们并不具备使用上述平均思想可靠估算 Y 所需的所有数据。甚至对于销售广告数据，你可以看到在图 2 中，对于 x=77.5，x=95，x=110 等，没有相应的 Y 值。*

*解决缺失数据问题的一个简单方法是使用邻域的概念。*

*![](img/e1e6bc0e51e8cc097f2a023b69649cb5.png)*
...
*![](img/cf9ad100ea643c21db4410bb98d29532.png)*

*图 3:对于 f(77.5)，我们取 75≥x≤80 的所有 Y 值的平均值*

*我们的定义和符号有一点改变，以反映我们不再局限于恰好出现在给定点 X=x 的 Y 值，而是现在查看出现在 X=x 的 ***邻域*** 中的 Y 值*

*![](img/f8ff4ed6d0099fb3a2f7f4e13493cba5.png)*

*这很好，直到我们遇到两个主要问题:*

*   *当除了报纸预算之外还有多个预测因素时会发生什么(例如:电视、广播、脸书广告、谷歌广告……)。在这种情况下，问题扩展到多个维度(不仅仅是 x 轴和 y 轴)，定义我们宝贵的小“邻居”变得越来越困难。(这个问题有个很厉害的名字:[维度的诅咒](https://en.wikipedia.org/wiki/Curse_of_dimensionality))*
...
*![](img/2c1be4341adba45976274c5b4ac0f159.png)*
