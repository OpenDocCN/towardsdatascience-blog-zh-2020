...
## 迪伦·哈德菲尔德-梅内尔在 [TDS 播客](https://towardsdatascience.com/tagged/tds-podcast)

要选择章节，请访问我们的 Youtube 视频[此处](https://youtu.be/NfElDoZ5O4Y)。

***编者按*** *:这一集是我们关于* [*数据科学和机器学习中出现的问题*](/emerging-problems-in-data-science-and-machine-learning-36d37f6531a8) ，*的播客系列的一部分，由 Jeremie Harris 主持。除了主持播客，Jeremie 还帮助运营一家名为*[*sharpes minds*](http://sharpestminds.com)*的数据科学导师初创公司。可以听下面的播客:*
...
你可以[在推特上关注迪伦](https://twitter.com/dhadfieldmenell)，你也可以[在推特上关注我](https://twitter.com/jeremiecharris)。

![](img/91646fa55c3b18c517e5d2a4548e50e2.png)
