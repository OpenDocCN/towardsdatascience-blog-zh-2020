...
![](img/10c0e0ad66c0821f5bdd302a8f2c0e60.png)
...
GPT 2 号是开源研究实验室 OpenAI 的成果。它是基于一篇名为[“语言模型是无监督的多任务学习者”](https://cdn.openai.com/better-language-models/language_models_are_unsupervised_multitask_learners.pdf)的研究论文创建的。该模型能够产生连贯的文本，并对文本的内容有清晰深刻的理解。它还能够将句子与其他句子联系起来，但最重要的是它能够在其输出中显示不同段落之间的清晰联系，从而提供长期和短期记忆理解。
...
感谢您的阅读，如果您希望复制代码，请访问我关于[如何使用 Google Colab](https://medium.com/@mhd.ali.nasser/step-by-step-guide-on-how-to-train-gpt-2-on-books-using-google-colab-b3c6fa15fef0?source=friends_link&sk=c97525bd641aea4b844874e4d445ba83) 训练 GPT-2 的文章。并访问我的 [Github 库](https://github.com/mohamad-ali-nasser/gpt-2/)获取更多信息。

在 [LinkedIn](https://www.linkedin.com/in/mohamad-ali-nasser-data-scientist/) 上连接。
查看我的[作品集](https://www.mohamadalinasser.com)中的其他项目。
关注[推特](https://twitter.com/mhd_ali_nasser)。
