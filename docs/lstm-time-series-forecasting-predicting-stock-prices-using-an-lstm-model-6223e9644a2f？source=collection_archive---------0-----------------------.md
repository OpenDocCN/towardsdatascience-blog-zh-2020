...
> 换句话说，它们有记忆能力。记住，LSTM 代表**长短期记忆模型。**
...
感谢**雅虎财经**我们可以免费**获得**的数据。使用以下链接获取**特斯拉**:[https://finance.yahoo.com/quote/TSLA/history?的股价历史周期 1=1436486400 &周期 2=1594339200 &间隔=1d &过滤器=历史&频率=1d](https://finance.yahoo.com/quote/TSLA/history?period1=1436486400&period2=1594339200&interval=1d&filter=history&frequency=1d)
...
下一步是**将**数据分割成**训练**和**测试**集合，以避免**过拟合**，并能够调查我们模型的泛化能力。要了解更多关于过度拟合的信息，请阅读本文:
...
在**模型** **拟合**之前，**归一化**数据不失为一个好主意。这将提高性能。你可以在这里阅读更多关于**最小-最大缩放器**:
