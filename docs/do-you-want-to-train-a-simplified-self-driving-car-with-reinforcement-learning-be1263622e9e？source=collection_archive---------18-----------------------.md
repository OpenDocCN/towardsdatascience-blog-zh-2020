...
## 试试我们新的 [LongiControl 环境](https://github.com/dynamik1703/gym_longicontrol)

![](img/69f8365046b4485855c210d988088af2.png)

[NeONBRAND](https://unsplash.com/@neonbrand?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) 在 [Unsplash](https://unsplash.com/?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) 上的照片
...
在我们仔细研究 Longicontrol 环境之前，我们将在下面简要描述一下 RL 的基础知识。如果你熟悉 RL，可以直接跳到**纵向控制部分。**
...
在纵向控制领域中，目标是车辆在给定时间内尽可能节能地完成单车道路线，而不造成事故。总之，这对应于在从 *t₀* 到 *T* 的间隔中使用的总能量 *E* 的最小化，作为功率 p 的函数:
...
![](img/b34e26011262b78d291b9c035c03d77a.png)
...
![](img/9eb5f5189c222153d97100e2f354d8a4.png)
...
![](img/6a4461f016c54a181cde856b9f9f3add.png)
...
![](img/7a7429d5055715e823214c00e05cd5ea.png)

图 4:学习过程的开始

在第一个示例中，我们看到了代理在培训开始时的动作。是的，你没看错，代理不动。所以我们让他训练一下:

![](img/8c21db48bd014b867de005fef4a3b0c8.png)

图 5:经过一些学习过程后

开了一段时间后，他开始开车，但无视限速。这是不可取的。因此，我们让他训练更长时间:

![](img/04a2b73cb53f2b8f74a9bc720ce42199.png)
...
![](img/510e9a7404fcdc35394b19f60e5990ce.png)

图 7:奖励权重[1，0，0，0]

**奖励例 2。**在第二个例子中，增加了对超速的处罚。这导致代理实际上保持限制。

![](img/542c21fa72abf375d25cdcc68f09aade.png)
...
这里有 [GitHub 链接](https://github.com/dynamik1703/gym_longicontrol)、[报纸](https://www.researchgate.net/publication/342747549_LongiControl_A_Reinforcement_Learning_Environment_for_Longitudinal_Vehicle_Control)和我的 [LinkedIn](https://www.linkedin.com/in/roman-lie%C3%9Fner-56346113b/) 简介

享受使用它😉

# 参考

[1] R .萨顿和 a .巴尔托，[强化学习简介](http://incompleteideas.net/book/first/the-book.html) (1988)，麻省理工学院出版社

[2] V. Mnih 和 K. Kavukcuoglu 和 D. Silver 和 A. Graves 和 I. Antonoglou 和 D. Wierstra 和 M. A. Riedmiller，[用深度强化学习玩雅达利](https://arxiv.org/abs/1312.5602) (2013)，CoRR

[3] D. Silver 和 J. Schrittwieser 和 K. Simonyan K 和 I. Antonoglou 和 A. Huang 和 A. Guez 和 T. Hubert 和 L. Baker 和 M. Lai 和 A. Bolton 等人[掌握没有人类知识的围棋游戏](https://www.nature.com/articles/nature24270) (2017)，《自然

[4] R. Liessner 和 C. Schroer 以及 A. Dietermann 和 b . bker，[混合动力电动汽车高级能源管理的深度强化学习](https://www.scitepress.org/Link.aspx?doi=10.5220/0006573000610072) (2018)，ICAART

[5] G .布罗克曼和 v .张和 l .彼得森和 j .施耐德和 j .舒尔曼和 j .唐和 w .扎伦巴，[开放健身房](https://arxiv.org/abs/1606.01540)。CoRR，2016。

[6] M. Andrychowicz，B. Baker，M. Chociej，R. Jozefowicz 等人[学习灵巧手操作](https://arxiv.org/abs/1808.00177)。CoRR，2018。

[7] F. Richter，R. K. Orosco，M. C. Yip，[外科机器人的开源强化学习环境](https://arxiv.org/abs/1903.02090)，CoRR，2019。

[8] T. P. Lillicrap 等人，[深度强化学习连续控制](https://arxiv.org/abs/1509.02971) (2015)，CoRR

[9] S. Uebel, [高效纵向混合动力汽车的能源管理策略](https://www.researchgate.net/publication/333000947_EINE_IM_HYBRIDFAHRZEUG_EINSETZBARE_ENERGIEMANAGEMENTSTRATEGIE_MIT_EFFIZIENTER_LANGSFUHRUNG)(2018),TU Dresden