...
## 肯尼宁上 [TDS 播客](https://towardsdatascience.com/podcast/home)

![](img/128daa8a179a1a386185e04e11270cab.png)

背景图片由[兰斯格兰达尔](https://unsplash.com/@lg17)
...
*   Kenny 强调了构建全栈产品的重要性，即使你是新手，只是想打入这个领域。我们在之前的几集里已经讨论过全栈数据科学的重要性(我也写了一篇关于[的](/the-economics-of-getting-hired-as-a-data-scientist-e3882933b43c)关于这个话题)但是它值得再次强调:即使你没有工作经验，你也可以将模型部署到 AWS 或 Google Cloud，并且理解使用 Docker 的容器化，或者使用 git 的版本控制。这些正迅速成为数据科学就业市场的新核心生存技能。
*   Better.com 在招人！你可以点击查看他们的数据科学职位招聘[。](https://boards.greenhouse.io/better/jobs/1424243)

你也可以在这里的 Twitter 上关注[肯尼，在这里](https://twitter.com/kenny_ning)关注我[。](https://twitter.com/jeremiecharris)