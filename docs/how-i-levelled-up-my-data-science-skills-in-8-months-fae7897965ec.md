...
![](img/9e0125e509a4b680e0c222cf5c95d337.png)

照片由[免费龙珠 Z 壁纸 6663](https://eskipaper.com/free-dragon-ball-z-wallpaper.html) 在 Eskipaper
...
![](img/e8f4c766fe7d6ac7b2e17d1daa974298.png)
...
每当我在 Kaggle 上查看人们在使用什么解决方案时，我总是会看到某种形式的助推、打包或深度学习。我对此有很好的理解，但深度学习对我来说是一个禁区。正是当我意识到这一点时，我决定报名参加 Coursera 上的[深度学习专业](https://www.coursera.org/specializations/deep-learning)。
...
因此，我给自己设定了一个挑战，从零开始编写许多最流行的机器学习算法——对于那些长期关注我的帖子的人来说，你会知道这是从零开始的[算法系列](https://towardsdatascience.com/tagged/algorithms-from-scratch)。
...
此外，我认为有必要提高我在关键数据科学框架方面的技能，如 NumPy 和 Pandas，因此我还创建了 [PyTrix 系列](https://towardsdatascience.com/tagged/Pytrix-series)。
...
在我个人看来，每个数据科学家都是一个个人品牌。维基百科对[企业家精神](https://en.wikipedia.org/wiki/Entrepreneurship)的定义是*创造或提取价值——*实际上，这是数据科学家的本质。
