...
> 原文：<https://towardsdatascience.com/how-to-keep-bias-out-of-your-ai-models-1867f8a7b69?source=collection_archive---------38----------------------->

## 人工智能模型是空的，中立的机器。当用有偏差的数据训练时，他们会产生偏差

![](img/4613f1fd307c98de21a228c496259af4.png)

如今，人工智能(AI)中的偏见备受争议。从图像分类器[给人们的脸贴不正确的标签](https://www.theverge.com/2019/1/25/18197137/amazon-rekognition-facial-recognition-bias-race-gender)到雇佣机器人[在筛选求职者时歧视女性](https://www.reuters.com/article/us-amazon-com-jobs-automation-insight/amazon-scraps-secret-ai-recruiting-tool-that-showed-bias-against-women-idUSKCN1MK08G)，当试图自动复制它们时，人工智能似乎继承了人类最糟糕的做法。
...
例如，前段时间，我做了一个机器人项目:[一个教师机器人](https://medium.com/@rosaria.silipo/emil-the-teacher-bot-ec6327e5b159)。这个想法是为关于开源数据科学软件 [KNIME Analytics Platform](https://www.knime.com/knime-analytics-platform) 的文档和特性的查询生成自动的信息答案。在所有的 bot 项目中，一个重要的问题是说话方式。
...
我没有从零开始构建深度学习网络，而是(跟随当前的趋势，在互联网上找到现有的例子)在 [KNIME Hub](https://hub.knime.com/) 中搜索类似的自由文本生成解决方案。我发现了一个例子，一个[类似的网络](https://kni.me/w/mGO9nXhmjzIKiqHU)在现有的真实山脉名称上进行训练，为一系列户外服装新产品生成虚拟的无版权的山脉候选名称。我下载了网络，并根据我的需要对其进行了定制，例如，将多对多转换为多对一架构。

该网络将在一组适当的自由文本上接受训练。在部署期间，将提供 M=100 个初始字符的触发语句，然后网络将继续自己组装它自己的自由文本。

![](img/f08ea8574f03bfee817aac1d9e543034.png)
...
![](img/c48d83b9fb564f03034dc02201f2f9d9.png)

人工智能生成的说唱歌曲的例子。红色的触发句是软件许可证文档的开始。

关于这个网络的建设、训练和部署的更多细节可以在文章“[人工智能生成的说唱歌曲](https://www.datasciencecentral.com/profiles/blogs/ai-generated-rap-songs)”中找到
...
关于这个网络的建设、训练和部署的更多细节可以在“[AI 能像莎士比亚一样写作吗？](/can-ai-write-like-shakespeare-de710befbfee)”

请记住，产生类似莎士比亚文本的神经网络与产生说唱歌曲的神经网络是同一个神经网络。一模一样。它只是在一组不同的数据上进行训练:一方面是说唱歌曲，另一方面是莎士比亚的戏剧作品。因此，产生的自由文本是非常不同的——正如在生产中产生的文本的偏差一样。

![](img/db84d5f37a36efdb7c73f842acb99cce.png)
...
*首次发表于* [*信息世界。*](https://www.infoworld.com/article/3514578/how-to-keep-bias-out-of-your-ai-models.html)