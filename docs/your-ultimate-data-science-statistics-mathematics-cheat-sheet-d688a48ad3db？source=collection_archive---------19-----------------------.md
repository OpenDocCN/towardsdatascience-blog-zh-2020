...
![](img/0b86827f6bc101cba0cf297303ad46ff.png)
...
**F1 得分**通过调和平均值结合了精确度和召回率。它的确切公式是`(2 × precision × recall) / (precision + recall)` **。**使用调和平均值是因为它惩罚更多的极值，与平均值相反，平均值是天真的，因为它对所有误差的加权都是一样的。
