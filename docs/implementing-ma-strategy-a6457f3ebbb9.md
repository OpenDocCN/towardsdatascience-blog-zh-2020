...
![](img/bc61cb47e435e0f280ca1fff42102d88.png)

由[杰森·布里斯科](https://unsplash.com/@jsnbrsc?utm_source=medium&utm_medium=referral)在 [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral) 上拍摄的照片
...
![](img/2201c4350829c7a7bf01483d6e0ba187.png)![](img/51c16207442e2caf3e1bcc19c9989938.png)
...
![](img/efb5273e564a0dbd9b44b627711f0347.png)![](img/f656a0a2acd6f16559fb8daee5a148d5.png)

我们可以看到，使用均线可以更同步、更精确地捕捉方差减少的时间序列。现在我们有了一个好的数据结构，我们将继续发展我们的交易策略。

# 制定贸易战略

如上所述，均线和均线都滞后于资产的实际价格。换句话说，资产的**实际**价格比移动平均价格变化快得多。因为实际价格更敏感，我们可以用两者的交叉点(实际价格和均线)来表示做空(卖出)或做多(买入)。

*   当原始资产价格从低于的**穿过均线系列时，我们将卖出所有空头头寸，买入一个单位的多头头寸**
*   当原始资产从上方的**穿过均线系列时，我们会平仓，通过卖出一个单位的资产来做空**
...
![](img/b21cbb2ac203e77dfcda024898f42a03.png)![](img/4e139a0d496e1774a4c9d75e1a589ace.png)

这将为我们提供一个包含价格差异的新数据框架，但我们确实希望将价格差异反映为“买入”或“卖出”的信号。我们可以使用一个 *numpy* 方法来分配这些。

![](img/d2ec5c9ad5b838482af84e0dad3dfa85.png)![](img/44e47b76b116659b3066afe8c64ce06b.png)

**重要提示:**因为我们使用的是原始时间序列中资产的“收盘”价格，我们实际上并不知道该价格高于均线价格。假设我们有一个多头头寸实际上与我们模型的数学不一致。只能假设收盘时我们**会**做多，也就是说明天的开仓也会做多。明天做多可以通过将我们的头寸向前移动一天来表示。

![](img/5de273db05cfb8837e1692967e3be235.png)

让我们看看我们的均线和原始资产价格是什么样的。我们还将绘制信号的时间序列，看看我们的头寸在日期窗口的过程中是如何变化的。

![](img/5e31aad62cc3fe549173bfea11d3afc0.png)
...
![](img/50fff06fcf15cc769586649244a9530c.png)

我们在整个时间段的总回报要求我们将持仓数据框架乘以资产的对数回报数据框架。

![](img/3e7b30b84078b615da190fb5ad297e20.png)

我们的数据框架现在包含了每个单个条目的回报，但是我们必须使用累计总和来查看总回报。然后，我们使用 *numpy* 将这些回报转换成相对回报。然后，我们将绘制出我们每项资产的累积对数收益以及它们的相对收益。

![](img/df5a707b6bdedf28244dd269032dc6c0.png)![](img/42e8ccb4844eefe80aa24d42de9078c7.png)

我们将把所有的对数收益相加，然后把它们转换成相对收益，从而得到一个统计上精确的收益近似值。绘制时，请记住这些值代表百分比，因此不要忘记将系列 y 值乘以 100 以获得准确的数字。

![](img/33d4f526c632b211c9d2720efabfef18.png)![](img/3fe37082e627b289727759ae6fc8648f.png)

# 决赛成绩

现在我们有了回报，我们现在可以使用复合回报假设来返回我们的终身投资组合回报以及我们的平均年回报。

![](img/3c824869f5a61b17fed8c3c5a9aba5b0.png)
