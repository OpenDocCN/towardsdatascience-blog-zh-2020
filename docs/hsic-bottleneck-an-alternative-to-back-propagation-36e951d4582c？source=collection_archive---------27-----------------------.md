...
![](img/2bc53addef32f7a6cf77a67625ba13b7.png)
...
嗯，我偶然看到一篇非常有趣的论文[1]研究这个问题:*HSIC 瓶颈:没有反向传播的深度学习*作者**万多·库尔特·马，J.P .刘易斯，w .巴斯蒂亚安·克莱恩**。他们利用信息论来完成这样的任务。

# 反向传播

反向传播是一种基于链式法则的算法，它能够计算损失函数相对于前馈神经网络中所有参数的偏导数。在该算法中，偏导数是在从最后一层到第一层的反向传递中计算的，因此称为反向传播，没有并行化的可能性。

我将不再进一步扩展反向传播。对这个算法的深入分析感兴趣的话，可以看看[迈克尔·尼尔森](http://michaelnielsen.org/)的这篇令人惊叹的博客 [2](http://neuralnetworksanddeeplearning.com/chap2.html) 。
...
![](img/4d221f5268e3c1889482e0147a635917.png)

离散随机变量的熵测度

![](img/bc835a588d28e22d90d4fd30425c18ca.png)
...
![](img/a7a4c86d7893f6a2c2cf00ea205812cc.png)

MI 作为 X 和 Y 的实际联合概率与联合分布(如果它们是独立的)之间的 Kullback Leibler 散度度量。

![](img/675c096b8ca57fc077699be13febf5c2.png)

离散案例

![](img/15746bee22e07a79d127da94d07e060b.png)

连续案例

正如我们所见，MI 测量两个随机变量的联合概率和两个变量的概率乘积之间的 [Kullback Leibler 散度](https://www.countbayesie.com/blog/2017/5/9/kullback-leibler-divergence-explained) [2]，就好像它们是独立的一样。对于两个独立变量，我们有 p(X，Y) = p(X)。p(Y)，导致零 KL 发散，然后是零 MI。当两个变量强烈相关时，观察到相反的情况:爆发 KL 散度。
...
![](img/3e2f8f590846bacf973b657fd44694bb.png)

[来源](https://www.mdpi.com/2624-6511/2/2/9)
...
![](img/bd75069b2502c42ab67125e18f4b443f.png)
...
IB 是由 [Naftali Tishby](https://en.wikipedia.org/wiki/Naftali_Tishby) ，Fernando C. Pereira 和 [William Bialek](https://en.wikipedia.org/wiki/William_Bialek) 介绍的一种方法。

![](img/b8be62cdfeec7a4541ded8b2cfe71100.png)

[信号源](https://www.researchgate.net/publication/265497360_Computational_Intelligence_Techniques_for_Missing_Data_Imputation)
...
![](img/ef77dd65fb255e3f4d494f467db833b1.png)
...
![](img/2fe39858217a5782f686811b6e26e428.png)
...
![](img/4460458ae9385cc435f920beaa41b9de.png)

[来源](https://arxiv.org/pdf/1908.01580.pdf)
...
![](img/69affd2380059a3b01797a63e85b1f88.png)

格式化模型。[来源](https://arxiv.org/pdf/1908.01580.pdf)
...
![](img/d708c2cc8e13c67575158fb8462c7d9d.png)

多尺度网络。[信号源](https://arxiv.org/pdf/1908.01580.pdf)
...
![](img/2bc2958b522950ae4293b0100f32dc33.png)

不同深度(层数)的深层网络的最后一个隐藏层、输入 X 和目标 Y 之间的 HSIC。[来源](https://arxiv.org/pdf/1908.01580.pdf)
...
![](img/1043ff23540b150317674d41f93a3e13.png)

HSIC 格式的模型与用反向传播训练的模型。[来源](https://arxiv.org/pdf/1908.01580.pdf)
...
[1]万多·库尔特·马，J.P .刘易斯，w .巴斯蒂亚安·克莱恩，[HSIC 瓶颈:没有反向传播的深度学习](https://arxiv.org/abs/1908.01580v3) (2019)，arxiv 2019

[2]迈克尔·尼尔森，[反向传播算法如何工作](http://neuralnetworksanddeeplearning.com/chap2.html)(2019 年 12 月)

[3]阿瑟·格雷顿，肯吉·福水，春辉·特奥，乐松，伯恩哈德·肖尔科普夫，亚历山大·j·斯莫拉，[2008 年《独立性的核统计检验》](https://papers.nips.cc/paper/3201-a-kernel-statistical-test-of-independence.pdf)，NeurIPS 2008

[4]亚历山大·a·阿莱米、伊恩·菲舍尔、约书亚·v·狄龙、凯文·墨菲[深度变分信息瓶颈](https://arxiv.org/abs/1612.00410) 2017、ICLR 2017