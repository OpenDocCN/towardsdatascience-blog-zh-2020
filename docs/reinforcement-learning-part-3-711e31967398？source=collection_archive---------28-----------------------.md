...
![](img/704aee7e545e07431ba66ff330287bfc.png)
...
[**上一讲**](/reinforcement-learning-part-2-d38cffee992d) **/** [**观看本视频**](https://youtu.be/fx0xgXH3jW8) **/** [**顶级**](/all-you-want-to-know-about-deep-learning-8d68dcffc258) **/** [**下一讲**](/reinforcement-learning-part-4-3c51edd8c4bf)

![](img/e0c032d672d46c13b8737bf6e0381044.png)

此外，马里奥并没有从强化学习中解脱出来。使用 [gifify](https://github.com/vvo/gifify) 创建的图像。来源: [YouTube](https://youtu.be/qv6UVOQ0F44) 。

欢迎回到深度学习！所以今天，我们想深入探讨强化学习。我们今天要解释的概念是政策迭代。它告诉我们如何制定更好的策略来设计赢得比赛的策略。

![](img/3c864d0d348e0a67769abb6053439899.png)

价值函数模拟了我们的水晶球。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/00d42d2084227546bad803303e2d1356.png)

记住网格世界。现在，我们可以计算每个状态的状态值函数。来自[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0CC 下的图片。
...
![](img/1a51c315c017a1b32c098e1ce79fc0cb.png)

行动价值函数估计每个状态下每个行动的预期未来回报。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/3b1cc71a1a72be95704a48c0713efd5d.png)

只能有一个 V*。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/cd7629a68a43d5372650caa9dbd13d1c.png)

均匀随机 V 和 V*的状态值函数。来自[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) 下的图片。
...
![](img/b417c12ce2ce4ac8d53734658974ae2a.png)

如何才能订购保单？ [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/88643708b8399b62a14f2eb1bb12f94d.png)

对状态值的贪婪行为选择。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/3b60528e8af48b3f48b7e3a258b7fa4d.png)

贝尔曼方程。来自[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) 下的图片。
...
![](img/4ca1c8010f328d11f146aac526118fbb.png)

贝尔曼方程也可以解释为更新规则。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/894b8d694dc3bee94449f0e83d646cd2.png)

政策是可以改进的。来自[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) 下的图片。
...
![](img/151ac2ba92b4ff012d163487a40355ec.png)

政策改进定理。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/80a02d832d41abf6be629d92b2963785.png)
...
![](img/33684bd87f0239801f6d7a641c9af500.png)

强化学习超级马里奥赛车 64。使用 [gifify](https://github.com/vvo/gifify) 创建的图像。来源: [YouTube](https://youtu.be/Eo07BAsyQ24) 。
...
[链接](http://incompleteideas.net/book/bookdraft2018jan1.pdf)到 Sutton 2018 年草案中的强化学习，包括深度 Q 学习和 Alpha Go 细节
