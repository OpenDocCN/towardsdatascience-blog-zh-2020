...
![](img/6be426c05521f50adb91636c12a48e81.png)
...
[**上一讲**](/activations-convolutions-and-pooling-part-4-5dd7f85aa9f7) **/** [**观看本视频**](https://youtu.be/-I3SQMfyZYw) **/** [**顶级**](/all-you-want-to-know-about-deep-learning-8d68dcffc258) **/** [**下一讲**](/regularization-part-2-5b729698d026)
...
![](img/697743d2940412b047ea3e2017c4b435.png)
...
![](img/2c133ae44f8a44fbd898146767c48ed9.png)

偏差-方差权衡与预期模型误差及其方差有关。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/4085f7278cedfdf353676bf60dc62398.png)

由偏差和方差引起的误差的可视化。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/9db9677e3eae7a3f786c15b8b8987fbe.png)

模型容量是对一个函数有多少变化可以近似的度量。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/a7b1ffb2e89999f73ec39ef88eb03b82.png)

您拥有的数据越多，就越有可能接近未知的测试集。来自[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) 下的图片。
...
![](img/8514058c9f29c6528a4682a0f9fc3834.png)

有限的数据集是过度拟合的常见原因。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/fcf3892aff702295a5c758ab4e74b7d4.png)

所有正则化技术都旨在减少过拟合问题。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/f84bcc69828700c12a38997c89d8f818.png)
