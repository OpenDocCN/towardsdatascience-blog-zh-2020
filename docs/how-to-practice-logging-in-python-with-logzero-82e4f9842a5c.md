...
![](img/2ced82fec835f3090683f137da0efbb1.png)

[儿子阮金的照片](https://www.toptal.com/resume/son-nguyen-kim?__hstc=753710.17be834d28ba29055621f0833fc6733b.1582400164835.1582400164835.1582400164835.1&__hssc=753710.1.1582400164836&__hsfp=3618320745)
...
![](img/7172534d63a89b884a401beae6192cdc.png)
...
在上面的例子中，我们配置了日志格式，包括*文件名、日期、时间、日志级别名称、*和*消息。*
...
除了使用默认的记录器，您还可以使用 **logzero.setup_logger(..)**。您可以使用不同的参数配置并返回一个完全配置的 logger 实例，如*名称、日志文件名称、格式化程序、最大字节数、备份计数、*和*日志记录级别。*
...
在本文中，您已经学习了如何使用 Logezero Python 包的基础知识和一些示例。您可以在[文档](https://logzero.readthedocs.io/en/latest/#)中了解更多可用功能。现在您可以开始在下一个 [python 项目](https://realpython.com/intermediate-python-project-ideas/)中实现 logzero 包了。

如果你学到了新的东西或者喜欢阅读这篇文章，请分享给其他人看。在那之前，下期帖子再见！也可以通过 Twitter [@Davis_McDavid](https://twitter.com/Davis_McDavid) 找到我

你可以阅读 [freecodecamp 的原文。](https://www.freecodecamp.org/news/good-logging-practice-in-python-with-logzero/)
