...
![](img/87faf8cb088befff50c8d0abcc689e8b.png)
...
[**上一讲**](/lecture-notes-in-deep-learning-introduction-part-5-a3b9faacd313) **/** [**观看本视频**](https://youtu.be/9eWxcYDSoXE) **/** [**顶级**](/all-you-want-to-know-about-deep-learning-8d68dcffc258) **/** [**下一讲**](/lecture-notes-in-deep-learning-feedforward-networks-part-2-c91b53a4d211)

![](img/9c9d965d12df20ba2922d9f692b23256.png)

这堂课的大纲。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/0d75d93e4abbccf636edfb1f27ca90be.png)

感知器描述了一个线性决策边界。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/29c58a29e800056a667af046708c0891.png)

经典的模式识别流水线。来自[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) 下的图片。
...
![](img/d583fc7a0616aa2022d32302ac8ceddc.png)

感知器不能解决非线性可分问题，如逻辑异或任务。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/ec3ca69ed24df1855969b13e949df58a.png)

2004 年，人工智能冬季项目的资金被大幅削减.图片来自 [Giphy](https://media.giphy.com/media/GgbCiS1rMjGFy/source.gif) 。

现在，如果你不能构建 XOR，那么你很可能无法描述整个逻辑，因此，我们永远不会实现强大的人工智能。这是一段时间，人工智能研究的所有资金都被大幅削减，人们将不会获得任何新的拨款。他们不会得到资金来支持这项研究。因此，这一时期被称为“艾冬天”。

![](img/89f7a1170e8ed85ea111346e4adfd52e.png)

从感知机到多层感知机。来自[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0CC 下的图片。
...
![](img/d08f4d66fdbb2dfef3422ac3b9ef2e94.png)

深层网络将许多层排列在彼此之上。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/8a4d5b4d9d1be2f115a78f3e72cff557.png)

泛逼近允许我们学习紧集上的任何连续函数 f( **x** )。来自[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0CC 下的图片。
...
![](img/df8fe0319f2e3c17cfda5aa463a529b7.png)

我们真的需要深度学习吗？图片来自[knowyourmeme.com](https://knowyourmeme.com/photos/534153-we-need-to-go-deeper)。
...
![](img/ceaabf44a75a514ae64b646255b446f5.png)

分类树可以细分ℝᵐ.的任何分区来自[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0CC 下的图片。
...
![](img/ce780fc6a48e0721597b06760056802c.png)

尝试将分类树转换为单个隐藏层网络。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/8da2e68c36af33982f78a98820e5febe.png)

在每个节点中创建的输入空间的空间细分的可视化。我们无法使用这种单层网络找到精确的解决方案。来自[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) 下的图片。
...
![](img/217ce0c6ddadf836c259f78d7e55f53c.png)

使用两层，任何分类树都可以映射到神经网络，而不会丢失信息。 [CC 下的图片来自](https://creativecommons.org/licenses/by/4.0/)[深度学习讲座](https://www.youtube.com/watch?v=p-_Stl0t3kU&list=PLpOGQvPCDQzvgpD3S0vTy7bJe2pf_yJFj&index=1)的 4.0 。
...
![](img/bf7134f1e028d15cf993a7d608ac1a1c.png)

我们反复出现的座右铭:我们需要更深入！图片来自[knowyourmeme.com](https://knowyourmeme.com/photos/531557-we-need-to-go-deeper)。
...
![](img/52a361b178425cc41c2feec379b0a26e.png)
