...
![](img/6a3995cfa73c85f0d11c012ae6f85250.png)

来源: [Pixabay](https://www.pexels.com/@pixabay) at Pexels —免费源图像
...
Pandas 为我们提供了一个整洁的表格，其中包含许多选项，来自于[其关于时间序列/日期功能的文档](https://pandas.pydata.org/pandas-docs/stable/user_guide/timeseries.html):

![](img/f1fe2eb4a84fe4414e646399455744b8.png)
...
以类似的方式，您可以从 [Panda 关于时间序列/日期功能的文档](https://pandas.pydata.org/pandas-docs/stable/user_guide/timeseries.html)中获得上表中列出的任何属性。

一旦我们这样做了，这些功能将如下所示:

![](img/8ee34e6926b4af185ca6f19520cc8d8c.png)
...
![](img/d37a17c2eac39e0c35a614ee8591ec65.png)
...
![](img/60b2d3966f708ac4f2741c8df52719f3.png)
...
好了，今天就到这里。请继续关注未来的故事，了解处理分类特征的其他技术。同时，这一年刚刚开始，你会在 2020 年找工作吗？好吧，那么你不能错过我关于获得第一份数据工作的实用技巧的故事。或者你还在寻找给自己的完美圣诞礼物？那就来看看这个关于[的故事 9 本数据科学相关书籍来读读](/9-data-science-related-books-to-ask-santa-for-christmas-37a1036478e9?source=friends_link&sk=089c71e8d8be1977dfe8a1b490501191)。如果这些都不是你的情况，请随时访问我在 Medium 上的个人资料，查看我的任何其他故事。
