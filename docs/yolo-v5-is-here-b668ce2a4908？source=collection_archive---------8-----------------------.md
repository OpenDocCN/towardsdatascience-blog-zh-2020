...
YOLO v1 于 2016 年 5 月由 Joseph Redmon 以论文“[你只看一次:统一的实时对象检测](https://arxiv.org/pdf/1506.02640.pdf)推出这是实时物体检测领域最大的进步之一。
...
![](img/5316a7eaf34c26fecd1c2cfb14ce5d7d.png)
...
使用 pip 或 [requirement.txt](https://github.com/mihir135/yolov5/blob/master/requirements.txt) 文件可以很容易地安装下面的依赖项。
...
首先，从 YOLOv5 的克隆存储库开始。如果你正在学习本教程，你可以从[这里](https://github.com/mihir135/yolov5)开始克隆。你可以从官方回购克隆，也可以在这里形成。
