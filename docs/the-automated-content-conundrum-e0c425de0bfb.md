...
> 原文：<https://towardsdatascience.com/the-automated-content-conundrum-e0c425de0bfb?source=collection_archive---------25----------------------->

## 新的人工智能机器人能够写故事、音乐、诗歌和代码——几乎和人类一样好。这对人类内容意味着什么？

![](img/3e4f17091ac59d6faebbb61b0f84d855.png)
...
我尝试了一个叫 AI writer 的服务，只是为了试试轮胎。要求写一篇关于“猫和狗”的文章(没有其他提示)，它生成了一篇两页的[文章](https://medium.com/@manu.chatterjee/cats-and-dogs-8d7ed5eeb00a)，附有 6 条参考文献。为了简洁，这里只有一段。

> “给猫介绍狗的时候，要注意双方动物的肢体语言。你的猫不开心的一个很好的迹象是当它的耳朵卡在后面或者尾巴前后摆动。虽然过去狗和猫成功地生活在一起，但重要的是要记住，狗和猫是个体，每次介绍都是不同的。”

这有点笨拙，但考虑一下这个来自 Open AI(一个致力于创建公共人工智能模型的组织)的“[情书](https://medium.com/merzazine/love-letters-written-by-a-toaster-e9e795c6409f)”摘录。在这里，科学家弗拉德·阿历克斯打开人工智能的 GPT-3 机器人，通过给出提示来创建情书。GPT-3 是他们的第三代人工智能建模技术。
...
他的[文章](https://medium.com/merzazine/love-letters-written-by-a-toaster-e9e795c6409f)非常精彩，展示了这项技术的创造力的深度。

# 聪明的人类还是机器人？

大学生利亚姆·波尔利用开放人工智能在一个博客网站上生成了[第一篇文章](https://www.businessinsider.com.au/fake-ai-generated-gpt3-blog-hacker-news-2020-8)。题目叫做[感觉不思进取？也许你应该停止过度思考。很少有人猜到它是自动创建的，少数猜到的人被讨论帖中的其他帖子嘲笑。](https://adolos.substack.com/p/feeling-unproductive-maybe-you-should)

虽然 GPT-3 现在受到了所有媒体的关注，但谷歌的项目 [Duplex](https://www.youtube.com/watch?v=D5VN56jQMWM) 可以进行逼真的语音通话。语音方面令人印象深刻，因为除了生成“合理的”语法和单词之外，它还具有交互性和自然的声音。

其他使用人工智能创作文章的服务已经存在，如 [Article Forge](https://www.articleforge.com/) 和 [AI Writer](http://ai-writer.com/) (如前所述)。给其中任何一个标题，他们会自动生成文章。然而，根据我的快速调查，他们比 GPT-3 落后一代。如果我们向前看(为了便于讨论，我会说是 GPT-4)，很明显高质量的内容将以惊人的规模出现。
...
[](https://openai.com/blog/musenet/) [## 穆塞内

### 我们创造了 MuseNet，一个深度神经网络，可以用 10 种不同的音乐创作 4 分钟的音乐作品…

openai.com](https://openai.com/blog/musenet/) 

从某种意义上说，音乐更容易“从零开始”创作，因为音乐理论(和弦、旋律和序列是如何组合在一起的)是众所周知的，也因为数字乐器(合成器和采样器)容易控制。只要按一个键，一个漂亮的音符就出来了。现在只需要把它们放在一起。这是另一个创建自动[吉他标签](https://twitter.com/AmandaAskell/status/1283900372281511937)的例子。
...
这里有一个简单的[例子](https://analyticsindiamag.com/open-ai-gpt-3-code-generator-app-building/)。将提示(用英语)创建一个带有待办事项列表的网页
...
与处理过的图像不同，没有可靠的方法来检测这些类型的自动化数字作品。没有水印，对语法、单词选择和内容的细微调整不足以区分机器生成的文本和人类。机器可以创建内容并将其发送到不同账户的**规模**也很重要。
...
*   [西蒙·奥里甘在《走向数据科学》中讨论了 GPT3 的用途](/gpt-3-demos-use-cases-implications-77f86e540dc1)
*   [The Verge 覆盖使用](https://www.theverge.com/2020/8/16/21371049/gpt3-hacker-news-ai-blog)开放人工智能的自动文本生成
*   [技术回顾概述文章](https://www.technologyreview.com/2020/07/20/1005454/openai-machine-learning-language-generator-gpt-3-nlp/)
*   [关于 GPT3 及其对 ycombinator 的局限性的讨论](https://news.ycombinator.com/item?id=23891226)
*   [大学生伪造顶级博文(商业内幕)](https://www.businessinsider.com.au/fake-ai-generated-gpt3-blog-hacker-news-2020-8)
*   [自动代码生成(分析印度杂志)](https://analyticsindiamag.com/open-ai-gpt-3-code-generator-app-building/)
*   [AI 音乐创作(连线)](https://www.wired.com/story/music-written-by-artificial-intelligence/)
*   [艾打破写作壁垒(华尔街日报)](https://www.wsj.com/articles/an-ai-breaks-the-writing-barrier-11598068862?mod=hp_featst_pos4)