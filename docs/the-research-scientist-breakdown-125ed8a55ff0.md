...
> 原文：<https://towardsdatascience.com/the-research-scientist-breakdown-125ed8a55ff0?source=collection_archive---------57----------------------->

## 研究科学家面试问题

![](img/b43c09fb5278f9039a02e053ae01755e.png)

图片来自 [Pixabay](https://pixabay.com/vectors/science-business-experiment-4496467/)

## ‌‌What:研究科学家做什么？‌‌

研究科学家和数据科学家之间的界限并不明确，但一般来说，研究科学家负责使用复杂的机器学习、数学和深度学习理论在一个非常小众的领域建立和开发模型。

虽然数据科学家和相邻职位处理大量数据和指标，但研究科学家**在特定的专业领域内封装了深刻的理解，与不同的团队跨职能合作，开发原型并验证假设。**
...
*   **所有数据:**你应该*非常*熟悉数据分析和可视化，以及如何将你的分析转化为可操作的见解。
...
![](img/06716a94acc78e72cb5ba4d89bc23f62.png)

*图片来自* [*Pixabay*](https://pixabay.com/illustrations/instagram-facebook-icon-instagram-3288413/)
...
*对 Lyft 感兴趣？观看我们的* [*Lyft 模拟面试视频*](https://www.youtube.com/watch?v=e2LJ-6NagpE) *，查看我们的* [*Lyft 面试文章*](https://www.interviewquery.com/blog-lyft-data-scientist-interview/) *！*
...
![](img/421d70a9869f5f2ae758939760caa054.png)

*图片来自* [*Pixabay*](https://pixabay.com/vectors/call-customer-support-woman-3613071/)
...
注意:一些面试官可能会把最初的电话面试和技术面试结合起来，或者干脆直接跳过前者，所以**确保你*总是*有所准备！‌‌**
...
文化和适合的问题肯定会出现，所以在进入面试之前，最好**研究公司价值观**并真正了解更多关于团队目标的信息。‌‌

最后，现场面试的结构很大程度上取决于公司本身。更大、更成熟的公司，如脸书、亚马逊、谷歌等。现场部分可能会有多个面试者和轮次，这意味着你可能会在一天的大部分时间里面试不同的团队成员、其他研究科学家等等。

# 科研人员面试问题的类型

![](img/acf4e1432255714ec3635039445ddfa1.png)

*图片来自* [*Pixabay*](https://pixabay.com/vectors/checklist-check-think-about-1266989/)
...
*如果您想了解有关案例研究问题的一般框架的更多细节和提示，请查看我们的* [*数据科学案例研究访谈*](https://www.interviewquery.com/blog-data-science-case-study-interview/) *文章。*
...
感谢您的阅读，要了解更多内容，[请务必查看采访查询，并加入数千名数据科学家和研究科学家的社区，为他们的下一次采访做准备。](https://www.interviewquery.com/) ‌‌‌‌‌‌‌‌‌‌‌‌
...
*   如果你对数据科学感兴趣，可以看看这篇关于我工作过的科技公司的 [**数据科学薪水**](https://www.interviewquery.com/blog-data-science-salaries/) 的深度阅读。

*原载于 2020 年 10 月 7 日 https://www.interviewquery.com**T21*[。](https://www.interviewquery.com/blog-research-scientist-breakdown/)