...
好消息(以及*秘密*)是:你不需要一个大型数据科学团队来从你的数据中获取价值(或者做 ML 甚至 AI)。关键是要有合适的技术，恰当地利用业务分析师的技能，他们可能会也可能不会编码，以有意义的方式为有影响的数据项目做出贡献。
...
如果你喜欢我的想法——在推特上关注我 [@qayyumrajan](http://twitter.com/qayyumrajan)