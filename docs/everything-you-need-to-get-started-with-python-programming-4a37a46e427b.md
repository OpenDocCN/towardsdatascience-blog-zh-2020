...
![](img/845dec479e84b715b266a5da82b6351c.png)

来自 [Pexels](https://www.pexels.com/photo/man-in-blue-and-white-striped-polo-shirt-sitting-beside-woman-in-brown-shirt-4842488/?utm_content=attributionCopyText&utm_medium=referral&utm_source=pexels) 的 [cottonbro](https://www.pexels.com/@cottonbro?utm_content=attributionCopyText&utm_medium=referral&utm_source=pexels) 摄影
...
照片由[乔希·索伦森](https://www.pexels.com/@joshsorenson?utm_content=attributionCopyText&utm_medium=referral&utm_source=pexels)从[派克斯](https://www.pexels.com/photo/black-flat-screen-computer-monitor-1714208/?utm_content=attributionCopyText&utm_medium=referral&utm_source=pexels)拍摄
...
你在键盘上打字的时间和看屏幕的时间差不多。毕竟你是*写*代码。对你有用的键盘，对另一个人来说可能是最糟糕的。选择合适的键盘是个人的事，只要记住你会用上几个小时，所以使用起来舒服很重要。

我过去用过各种键盘，最近扔掉了我定制的 [WASD](https://www.wasdkeyboards.com) 键盘，换上了一个[苹果魔法键盘](https://www.apple.com/shop/product/MQ052LL/A/magic-keyboard-with-numeric-keypad-us-english-silver?fnode=b49659f91c9f7729af62a9f7083c21fe17b4127269e75f09377db663a16fb948d94b0eb1ecbf921523a6b857cde84a76cb98a6210c298c0e65a785290b1094c434bd2d4e666736543ce20e3f53e24fa7674fb6c09799ffa8c729d7ae8b62cbf8)。

![](img/79d15f846f564df30ad1266723f1872f.png)
...
虽然我很喜欢苹果的神奇键盘，但神奇鼠标并没有那么棒。在我看来，苹果从来就不擅长鼠标，而[苹果神奇鼠标](https://www.apple.com/shop/product/MRME2/magic-mouse-2-space-gray?fnode=7211309b4a68c673a35f78d425d260a1cefa0de8eb7df008dbbd77739061dbb9587e4ef4e681acf2ec9e3ed208ca52fa9f50d38cafa5289038df4a78ac4b3ccd9d32bc03abf4209bd2b5d7b92179aadbf017bda748335bfdf157db82b23c40c2)的人机工程学外形非常糟糕。我最近使用它的唯一原因是因为它上面集成了触控板。它非常适合浏览，但当我需要做一些更繁重的工作时，我旁边有一个 Steelseries Kana，因为握起来更舒服。

![](img/1f30cf79b9803c8e6661f214b23ccaea.png)

苹果魔术鼠标与支持钢系列假名。作者图片

购买鼠标时，您应该考虑外形因素。使用普通键盘已经让你的手腕扭曲到不自然的位置。你可以考虑用一个稍微垂直的鼠标来减轻你手腕的压力。[罗技 MX Master 3](https://www.logitech.com/en-us/products/mice/mx-master-3.910-005620.html) 目前是一个受欢迎的选择，并略有倾斜。我目前有这个订单，并希望它像所有评论说的那样好。如果效果更好的话，你可以得到全垂直布局或操纵杆布局的鼠标。
...
![](img/48b27f68fbbc77f0a8c83184ebd05076.png)

来自 [Pexels](https://www.pexels.com/photo/man-in-gray-crew-neck-t-shirt-sitting-at-the-table-4827507/?utm_content=attributionCopyText&utm_medium=referral&utm_source=pexels) 的 [cottonbro](https://www.pexels.com/@cottonbro?utm_content=attributionCopyText&utm_medium=referral&utm_source=pexels) 摄影
...
根据 [Just Josh](https://www.youtube.com/watch?v=WutBn_mm0c8) 的说法，与他的 Surface Book 2 15 英寸和 Aero 17 英寸笔记本电脑相比，他可以在 Macbook Pro 16 英寸上查看多 30%的代码行。它们都具有相同的 8.5 英寸垂直屏幕高度。
...
一些制造商还不如*不*包括触控板。以我的经验来看，没有人能与 MacBook 触控板相媲美。也许是 Razer，但我自己没有试过，只听同事说它很棒。如果你不想带鼠标，确保你对触控板满意。
...
根据 [Stack Overflow 的 2020 年调查](https://insights.stackoverflow.com/survey/2020#development-environments-and-tools)，45.8%使用 Windows 开发，27.5%在 macOS 上工作，26.6%在 Linux 上工作。
...
更好的新来者是 [Windows 终端](https://github.com/microsoft/terminal)。这款高度可定制的终端非常好用。

![](img/c791279d43e2e480f4ee0a2a3765c0d9.png)
...
*   代码预测。如果你已经创建了一个名为`ninja_turtles`的变量，在你开始输入 ninj 之后，编辑器会预测你的变量名，这很好……让软件在你输入的时候寻找模块可以用于快速编码和学习。
*   制表符缩进。大多数编辑器允许你选择你想要在一个标签中有多少空格。Python 的 PEP8(圣经)指出你应该使用 [4 个空格](https://www.python.org/dev/peps/pep-0008/#indentation)。Python 3 甚至不允许混合制表符和空格。
...
![](img/40dae01f80da10b1e423905b7d3e8385.png)
...
![](img/822f1ee6eae58078d2f398af70313932.png)
...
你可能以前见过使用 Jupyter[的漂亮的图形数据展示。可以安装 Jupyter 笔记本，也可以使用浏览器版本。如果你想处理数据，Jupyter 是你的工具。](https://jupyter.org/index.html)

![](img/bee70cbba8a8f560d346f55b8bf870de.png)
...
要找到适合你的版本，去他们的[比较页面](https://visualstudio.microsoft.com/vs/compare/)看看，并确保你看了他们的 [python 特定页面](https://visualstudio.microsoft.com/vs/features/python/)。
...
[Pythonista](http://omz-software.com/pythonista/) 是一款流行的软件，是一款面向手机开发的完整 IDE。

Koder 是另一种选择。这是一个代码编辑器，不是一个完整的 IDE，但它有语法高亮显示和对 Dropbox 等云服务的支持。

[Buffer Editor](https://buffereditor.com) 看起来圆滑简约。它支持 Git 和 Dropbox。
...
![](img/0eebaccee84f7bbd5c41edb19d93495b.png)

repl.it 运行“生命的游戏”。作者图片

## Pythonanywhere

顾名思义， [pythonanywhere](http://pythonanywhere.org) 让你无论身在何处都可以编码。这项服务是 python 独有的，在免费版本中你可以同时运行两个控制台。

![](img/0c7d8e29dd6f85c5b54090f7adace402.png)
...
![](img/5316329850b5b0dce99ad67df5db3f9c.png)
...
当然，买你买得起的。你必须时刻考虑你采购的东西是否*需要*，但是硬件永远不可能*太好*。
